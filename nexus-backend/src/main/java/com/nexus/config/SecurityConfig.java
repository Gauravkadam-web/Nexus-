...
import com.nexus.auth.security.RateLimitingFilter;
...
/**
 * Spring Security configuration for Nexus Backend.
 * Enforces stateless JWT authentication and permits public health/auth endpoints.
 */
@Configuration
@EnableWebSecurity
